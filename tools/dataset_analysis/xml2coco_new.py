...
if __name__ == '__main__':
    ...
    parser.add_argument(
        "--json-file",
        default='/shared/xjd/DataSets/transmission_line_detection/train_add_GanTa_data2.json',
        type=str,
        help='Output COCO format json file.'
        )
    parser.add_argument(
        "--json-file2",
        default='/shared/xjd/DataSets/transmission_line_detection/test_add_GanTa_data2.json',
        type=str,
        help='Output COCO format json file.'
        )
