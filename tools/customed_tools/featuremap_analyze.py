...
from mmcv import (Config, load_checkpoint, FeatureMapVis, show_tensor, imdenormalize, show_img, imwrite,
                           traverse_file_paths)
...
def show_featuremap_from_imgs(featurevis, feature_indexs, img_dir, mean, std, is_show, output_dir):
    ...
    img_paths = traverse_file_paths(img_dir, 'demo.jpg')    # 将.jpg换成了demo.jpg
