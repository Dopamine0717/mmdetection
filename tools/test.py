...
from tools.customed_tools.result2json import result2json
...
def parse_args():
    ...
    parser.add_argument('--out', help='output result file in pickle format')    # TODO:保存为json文件
    parser.add_argument(
        '--fuse-conv-bn',
        action='store_true',
...
def main():
    ...
    if not distributed:
        ...
        outputs = single_gpu_test(model, data_loader, args.show, args.show_dir,    # 最重要的内容
                                  args.show_score_thr)
    else:
    ...
    if rank == 0:
        ...
        # result2json(outputs, dataset, **kwargs)
