...
data = dict(
    ...
    train=dict(
        type='OurDataset',
        ann_file=
        '/shared/xjd/DataSets/transmission_line_detection/instances_train.json',
        img_prefix='/shared/xjd/DataSets/transmission_line_detection/',
        pipeline=[
            dict(type='CustomLoadImageFromFile'),
            dict(type='LoadAnnotations', with_bbox=True),
            dict(type='Resize', img_scale=(3600, 2400), keep_ratio=True),
    ...
    val=dict(
        type='OurDataset',
        ann_file=
        '/shared/xjd/DataSets/transmission_line_detection/instances_test.json',
        img_prefix='/shared/xjd/DataSets/transmission_line_detection/',
        pipeline=[
            dict(type='CustomLoadImageFromFile'),
            dict(
...
lr_config = dict(
    policy='step', warmup=None, warmup_iters=0, warmup_ratio=0.001, step=[5])
...
work_dir = 'work_dirs2/lr0.01_custom_bigimgscale2_loadfromepch20'
gpu_ids = range(0, 3)
