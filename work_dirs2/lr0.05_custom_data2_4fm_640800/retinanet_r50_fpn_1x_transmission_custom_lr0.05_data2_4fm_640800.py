...
train_pipeline = [
    ...
    dict(type='Resize', img_scale=(640, 800), keep_ratio=True),
...
data = dict(
    ...
    train=dict(
        type='OurDataset',
        ann_file=
        '/shared/xjd/DataSets/transmission_line_detection/instances_train30462.json',
...
work_dir = 'work_dirs2/lr0.05_custom_data2_4fm_640800'
gpu_ids = range(0, 4)
