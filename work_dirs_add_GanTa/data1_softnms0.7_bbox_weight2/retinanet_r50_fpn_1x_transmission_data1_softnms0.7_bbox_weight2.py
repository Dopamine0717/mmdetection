...
data = dict(
    ...
    train=dict(
        type='OurDataset',
        ann_file=
        '/shared/xjd/DataSets/transmission_line_detection/train_add_GanTa.json',
    ...
    val=dict(
        type='OurDataset',
        ann_file=
        '/shared/xjd/DataSets/transmission_line_detection/test_add_GanTa.json',
        img_prefix='/shared/xjd/DataSets/transmission_line_detection/',
        pipeline=[
            dict(type='CustomLoadImageFromFile'),
            dict(
...
classes = ('DaoXianYiWu', 'DiaoChe', 'ShiGongJiXie', 'TaDiao', 'YanHuo',
           'GanTa')
work_dir = 'work_dirs_add_GanTa/data1_softnms0.7_bbox_weight2'
gpu_ids = range(0, 4)
