...
resume_from = 'work_dir_luo/detr_data1_query100_loadfb_coslr_CIoU_bboxweight5/epoch_15.pth'
workflow = [('train', 1)]
work_dir = 'work_dir_luo/detr_data1_query100_loadfb_coslr_CIoU_bboxweight5'  # workdir
gpu_ids=range(0,4)
