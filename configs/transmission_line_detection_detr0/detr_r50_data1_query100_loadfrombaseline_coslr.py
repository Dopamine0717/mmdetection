...
resume_from = 'work_dir_luo/detr_data1_query30_loadfrombaseline_coslr/epoch_15.pth'
workflow = [('train', 1)]
work_dir = 'work_dir_luo/detr_data1_query100_loadfrombaseline_coslr'  # workdir
gpu_ids=range(0,4)
