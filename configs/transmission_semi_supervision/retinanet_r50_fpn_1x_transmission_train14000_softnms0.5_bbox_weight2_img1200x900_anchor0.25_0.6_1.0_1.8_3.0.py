...
load_from = 'work_dirs3/data1_softnms0.5_bbox_weight2_img1200x900_anchor0.25_0.6_1.0_1.8_3.0/epoch_20.pth'
optimizer = dict(type='SGD', lr=0.01, momentum=0.9, weight_decay=0.0001)
lr_config = dict(
    policy='step',
    warmup=None,
...
data = dict(
    samples_per_gpu=12,    # samples_per_gpu=6,
    workers_per_gpu=8,
    ...
    train=dict(
        ...
        ann_file=data_root + 'train14000.json',    # data1:instances_train.json  data2:instances_train30462.json
        classes=classes,
        pipeline=train_pipeline),
    val=dict(
        type=dataset_type,
        img_prefix=data_root,
        ann_file=data_root + 'train14000.json',
