...
evaluation = dict(interval=1, metric='bbox', classwise=True, 
    jsonfile_prefix='work_dir_202/retinanet_data1_softnms0.3_bbox_weight2_mstrain_anchor0.25_0.6_1.0_1.8_3.0_see_classAP/evaluation')
...
train_pipeline = [
    ...
    dict(type='Resize', img_scale=[(1200, 900),(1800, 1350)], keep_ratio=True),
