...
load_from = 'checkpoints/retinanet_r50_fpn_rsb-pretrain_1x_coco_20220113_175432-bd24aae9.pth'
optimizer = dict(
    _delete_=True,
    type='AdamW',
    lr=0.0001,
...
evaluation = dict(interval=1, metric='bbox', classwise=True, 
    jsonfile_prefix='work_dirs_r50rsb/retinanet_r50rsb_data1_loadfrom/evaluation')
