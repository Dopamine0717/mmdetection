...
data = dict(
    ...
    val=dict(
        type=dataset_type,
        img_prefix=data_root,
        ann_file=data_root + 'test_demo.json',
        classes=classes,
    ...
    test=dict(
        ...
        classes=classes,
        pipeline=test_pipeline))
# evaluation = dict(interval=1, metric='bbox', jsonfile_prefix='work_dirs2/retinanet_transmission_test/custom_lr0.05_data2_newanchor7_5fm')
