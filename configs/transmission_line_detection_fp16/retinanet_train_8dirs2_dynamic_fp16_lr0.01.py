...
evaluation = dict(interval=1, metric='bbox', classwise=True, 
    jsonfile_prefix='work_dirs_fp16/retinanet_train_8dirs2_dynamic_fp16_lr0.01/evaluation')
...
data = dict(
    ...
    train=dict(
        ...
        ann_file=data_root + 'train_8dirs2.json',    # data1:instances_train.json  data2:instances_train30462.json
        classes=classes,
