...
evaluation = dict(interval=1, metric='bbox', classwise=True, 
    jsonfile_prefix='work_dirs_fp16/retinanet_data1_add_ganta1_and_selflabeled_dynamic_fp16_testGanTa_baseline/evaluation')
...
data = dict(
    ...
    train=dict(
        ...
        ann_file=data_root + 'data1_add_ganta1_and_self_labeled.json',    # data1:instances_train.json  data2:instances_train30462.json
        classes=classes,
        pipeline=train_pipeline),
    val=dict(
        type=dataset_type,
        img_prefix=data_root,
        # ann_file=data_root + 'test2.json',
