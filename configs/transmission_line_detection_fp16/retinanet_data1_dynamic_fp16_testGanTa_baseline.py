...
evaluation = dict(interval=1, metric='bbox', classwise=True, 
    jsonfile_prefix='work_dirs_fp16/retinanet_data1_dynamic_fp16_testGanTa_baseline/evaluation')
...
data = dict(
    ...
    train=dict(
        ...
        ann_file=data_root + 'train_add_GanTa.json',    # data1:instances_train.json  data2:instances_train30462.json
        classes=classes,
