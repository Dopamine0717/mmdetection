...
evaluation = dict(interval=1, metric='bbox', classwise=True, 
    jsonfile_prefix='work_dirs_fp16/retinanet_train_6dirs_dynamic_fp16_baseline/evaluation')
...
data = dict(
    ...
    train=dict(
        ...
        ann_file=data_root + 'train_6dirs.json',    # data1:instances_train.json  data2:instances_train30462.json
        classes=classes,
