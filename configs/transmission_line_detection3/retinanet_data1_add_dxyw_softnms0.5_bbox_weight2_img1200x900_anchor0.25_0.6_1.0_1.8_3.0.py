...
evaluation = dict(interval=1, metric='bbox', classwise=True, 
    jsonfile_prefix='work_dirs3/data1_add_dxyw_softnms0.5_bbox_weight2_img1200x900_anchor_0.25_0.6_1.0_1.8_3.0/evaluation')
...
data = dict(
    ...
    train=dict(
        ...
        ann_file=data_root + 'data1_add_dxyw.json',    # data1:instances_train.json  data2:instances_train30462.json
        classes=classes,
