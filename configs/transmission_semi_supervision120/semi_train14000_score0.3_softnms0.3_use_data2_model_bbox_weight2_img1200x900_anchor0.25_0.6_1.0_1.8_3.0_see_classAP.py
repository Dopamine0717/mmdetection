...
evaluation = dict(interval=1, metric='bbox', classwise=True, 
    jsonfile_prefix='work_dirs_semi_supervision/train14000_score0.3_use_data2_model_softnms0.3_bbox_weight2_img1200x900_anchor0.25_0.6_1.0_1.8_3.0_see_classAP/evaluation')
...
data = dict(
    ...
    train=dict(
        ...
        ann_file=data_root + 'train14000_score0.3_use_data2_model_result2json.bbox.json',    # data1:instances_train.json  data2:instances_train30462.json
        classes=classes,
