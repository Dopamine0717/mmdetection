...
data = dict(
    ...
    train=dict(
        type='CocoDataset',
        ann_file=
        '/shared/xjd/DataSets/transmission_line_detection/train30462.json',
        img_prefix='data/transmission_line_detection/',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(type='LoadAnnotations', with_bbox=True),
            dict(type='Resize', img_scale=(1333, 800), keep_ratio=True),
    ...
    val=dict(
        type='CocoDataset',
        ann_file=
        '/shared/xjd/DataSets/transmission_line_detection/test30462.json',
        img_prefix='data/transmission_line_detection/',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
